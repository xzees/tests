    ...
    res
      ...
      .send(
        oneLineTrim(
          ...
          ${
            dataGateway?.seo?.title != undefined &&
            `<title>${dataGateway?.seo?.title}</title>`
          }
          ...
          <meta property="og:title" content="${
            dataGateway?.seo?.title
              ? dataGateway?.seo?.title
              : `บริษัททัวร์คุณภาพ ชั้นนำ ท่องเที่ยวครบวงจร - ไทยทราเวลเซ็นเตอร์`
          }">
          <meta property="og:site_name" content="Thai Travel Center">
          <meta property="og:description" content="${
            dataGateway?.seo?.description
              ? dataGateway?.seo?.description
              : `โลกทั้งใบอยู่ใกล้แค่เอื้อม ด้วยบริการท่องเที่ยวดีดี ตั๋วเครื่องบิน แพคเกจทัวร์ จองโรงแรม บริการจัดทัวร์ครบวงจร เที่ยวไปได้ทั่วโลกกับบริษัทท่องเที่ยวคุณภาพ`
          }">
          <meta property="og:image" content="https://www.thaitravelcenter.com/webdatas/image/fb-opengraph-thaitravelcenter.jpg">
          <meta property="og:type" content="website">
          <meta property="og:url" content="https://www.thaitravelcenter.com${
            req.url != "/" ? req.url : ``
          }">
          ...
          ${
            !isBotAgent
              ? isProduction
                ? `<script src="${assets.client.js}" defer></script><script type="text/javascript" src="https://www.thaitravelcenter.com/template/theme/js/lazysizes.min.js"></script>`
                : `<script type="text/javascript" src="https://www.thaitravelcenter.com/template/theme/js/lazysizes.min.js"></script><script src="${
                    assets.client.js
